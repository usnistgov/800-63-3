...
A subscriber's information SHALL be transmitted between IdP and RP only for an identity federation transactions or functions such as identification of compromised accounts as discussed in [Section 5.2](#privacy-reqs). A subscriber's information SHALL NOT be transmitted for any other purposes, even when those parties are whitelisted.
